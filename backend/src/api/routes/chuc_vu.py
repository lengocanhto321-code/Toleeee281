...
@router.post("", response_model=APIResponse[ChucVuDataResponse], status_code=status.HTTP_201_CREATED)
...
async def get_list_chuc_vu(
    ...
    cap_bac_min: Optional[int] = Query(None, ge=1, le=10, description="Lọc theo cấp bậc tối thiểu"),
    cap_bac_max: Optional[int] = Query(None, ge=1, le=10, description="Lọc theo cấp bậc tối đa"),
