...
async def get_list_cau_hinh_luong(
    ...
    use_case = GetListCauHinhLuongUseCase(uow)
...
async def create_luong(
    ...
    use_case = CreateLuongUseCase(uow)
    result = await use_case.execute(command)
...
async def get_luong_hien_tai(
    ...
    use_case = GetLuongHienTaiUseCase(uow)
    result = await use_case.execute(query)
...
async def get_list_ky_luong(
    ...
    use_case = GetListKyLuongUseCase(uow)
    result = await use_case.execute(query)
...
async def get_tra_luong_by_ky_luong(
    ...
    use_case = GetTraLuongByKyLuongUseCase(uow)
    result = await use_case.execute(query)
...
async def get_tra_luong_detail(
    ...
    use_case = GetTraLuongDetailUseCase(uow)
    result = await use_case.execute(query)
...
async def duyet_ky_luong(
    ...
    use_case = DuyetKyLuongUseCase(uow)
    result = await use_case.execute(command)
...
async def chot_ky_luong(
    ...
    use_case = ChotKyLuongUseCase(uow)
    result = await use_case.execute(command)
