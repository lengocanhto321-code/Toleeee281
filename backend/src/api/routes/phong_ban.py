...
from src.app.usecases.phong_ban.create_phong_ban_uc import CreatePhongBanCommand, CreatePhongBanUseCase
from src.app.usecases.phong_ban.update_phong_ban_uc import UpdatePhongBanCommand, UpdatePhongBanUseCase
from src.app.usecases.phong_ban.delete_phong_ban_uc import DeletePhongBanCommand, DeletePhongBanUseCase
...
async def update_phong_ban(
    ...
    """Cập nhật phòng ban."""
    command = UpdatePhongBanCommand(id=id, data=body, actor_id=str(user_context.user_id))
