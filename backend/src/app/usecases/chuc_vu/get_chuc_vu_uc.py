...
class GetChucVuUseCase:
    ...
    async def get_list(self, query: GetListChucVuQuery) -> Result[GetListChucVuResult, Error]:
        """Get paginated list of ChucVu sorted by cap_bac."""
        logger.info(f"Getting ChucVu list: page={query.page}, page_size={query.page_size}")
    ...
    async def get_detail(self, query: GetDetailChucVuQuery) -> Result[GetDetailChucVuResult, Error]:
